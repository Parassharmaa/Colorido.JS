target1 = document.getElementsByClassName('colorido'); // background-color
target2 = document.getElementsByClassName('colorido-o'); // with opacity
target3 = document.getElementsByClassName('colorido-t'); // text color
target4 = document.getElementsByClassName('colorido-gr'); //radial gradient
target5 = document.getElementsByClassName('colorido-gl'); // linear gradient
target6 = document.getElementsByClassName('colorido-gd'); // diagonal gradient
target7 = document.getElementsByClassName('colorido-gh'); //horozontal gradient
